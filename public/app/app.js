...
angular.module('app').config(function ($routeProvider, $locationProvider) {
  ...
  $routeProvider
      ...
      .when('/schedule/member/group/:groupId', { templateUrl: '/partials/schedule/member', controller: 'memberController'})
      .when('/schedule/member/:id', { templateUrl: '/partials/schedule/member_edit', controller: 'editMemberController'})
